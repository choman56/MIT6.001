...
def test_playHand(word_list):
    '''
    Parameters
    ----------
    word_list : list of lowercase strings
        word_list contains all valid possible words, loaded up from file
...
print("----------------------------------------------------------------------")
print("Testing deal hand (with wild card)....")
test_deal_hand()
print('----------------------------------------------------------------------')
